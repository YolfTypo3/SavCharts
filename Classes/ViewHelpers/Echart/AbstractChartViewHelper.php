...
abstract class AbstractChartViewHelper extends AbstractSavChartsViewHelper
{
    ...
    public function initializeArguments(): void
    {
        ...
        $this->registerArgument('options', 'string', 'Options, or a reference to options', true);
    ...
    public function render(): void
    {
        ...
        $viewHelperVariableValue = [
            ...
            'options' => array_merge_recursive($this->configuration['options'], $this->getByReference($options)),
